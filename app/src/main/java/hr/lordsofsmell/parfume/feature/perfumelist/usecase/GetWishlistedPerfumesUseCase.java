...
public class GetWishlistedPerfumesUseCase extends UseCase<Long, List<PerfumeItem>>
        implements IPerfumeList.GetWishlistedPerfumesUseCase {

    private IRepository repository;

    @Inject
    public GetWishlistedPerfumesUseCase(@NonNull ThreadExecutor threadExecutor,
    ...
    protected Observable<List<PerfumeItem>> createObservable(Long userId) {
        if (userId == null) {
            ...
            return repository.getWishlistedParfumes(userId);
        }
    }
}
