...
public class GetOwnedPerfumesUseCase extends UseCase<Long, List<PerfumeItem>>
        implements IPerfumeList.GetOwnedPerfumesUseCase {

    private IRepository repository;

    @Inject
    public GetOwnedPerfumesUseCase(@NonNull ThreadExecutor threadExecutor,
    ...
    protected Observable<List<PerfumeItem>> createObservable(Long userId) {
        if (userId == null) {
            ...
            return repository.getOwnedParfumes(userId);
        }
    }
}
